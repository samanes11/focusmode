  ...
  if (percentage < 70)
    return (
      <span className="text-[14px] flex items-center gap-2">
        <span className="inline-block w-2 h-2 bg-[#d4a574] rounded-full animate-pulse" />
        قهوه در حال آماده شدن است
      </span>
    );
  if (percentage < 100)
    return (
      ...
      <div className="relative p-8 pb-4">
        <div className="relative w-full max-w-xs mx-auto">
          ...
          >
            ...
            {/* Body */}
            <path
              d="M 40 80 L 40 220 Q 40 240 60 240 L 140 240 Q 160 240 160 220 L 160 80 Q 160 60 140 60 L 60 60 Q 40 60 40 80"
            ...
            />
            <path
              d="M 45 80 L 45 218 Q 45 235 60 235 L 140 235 Q 155 235 155 218 L 155 80"
              fill="none"
              stroke="#292524"
              strokeWidth="1"
              opacity="0.5"
            ...
            {/* Handle */}
            <path
              d="M 160 100 Q 185 100 185 125 L 185 135 Q 185 160 160 160"
              fill="none"
          ...
          {percentage > 30 && (
            <div className="absolute inset-0 pointer-events-none">
              ...
              <div
                className="absolute top-1/3 right-1/4 w-1 h-1 bg-amber-400/40 rounded-full animate-ping"
        ...
        <Window style={{ backgroundColor: "#1a1410", borderRadius: 16 }}>
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-[14px] font-medium text-[#a0826d]">
                پیشرفت دم کشیدن
              </span>
            ...
            <div className="relative h-3 bg-[#2a221c] rounded-full overflow-hidden mb-4 shadow-inner">
              <div
                ...
                style={{
                  width: `${percentage}%`,
                  background:
                    "linear-gradient(90deg, rgba(212,165,116,0.95) 0%, rgba(196,148,100,0.95) 100%)",
